...
l2_associativity=[1]
l1d_cache_sizes = [128]
l1i_cache_sizes = [1,2,4,8,16,32,64,128]
l2_cache_sizes = [1]
                ...
                for l1d_size in l1d_cache_sizes:
                    for l1i_size in l1i_cache_sizes:
                        for l2_size in l2_cache_sizes:
                            ...
                            output_dir = "/home/013/a/ax/axb230073/CA_Project2/OutputS6/458.sjeng/458_{}-{}-{}-{}-{}-{}-{}".format(cache_line_size, l1d_assoc, l1i_assoc, l2_assoc, l1d_size, l1i_size, l2_size)
